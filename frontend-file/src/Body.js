...
{/* <!-- About --> */}
   <section className="about-section" id="about">
     ...
     <Link to="/product">
      <button className="btn2" id="decorativeOrnamentsBtn"><i class="bi bi-cart-fill"></i> Start Shop</button>
      </Link>
     </div>
    </div>
...
<div className="banner-map">
    ...
    <div className='details'>
      ...
      <h5><i class="bi bi-envelope-at-fill"></i>  mask@gmail.com</h5>
      <h5><i class="bi bi-geo-alt-fill"></i>  Valanpuram, Jaffna.</h5>
      <h5><i class="bi bi-telephone-fill"></i>  94-123465789</h5>
